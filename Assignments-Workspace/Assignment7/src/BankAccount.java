...
abstract class BankAccount {
	 ...
	 * @param receivingAccount The account to transfer the money to.
	 */
	...
	/**
	 * 
	 * Should return the monthly change in balance. Negative if the balance should go down and positive if the balance should increase
	 * 
	...
	/**
	 * Updates the balance of the account with any increases due to interest or decreases due to fees
	 * 
	 */
